...
import { Plus, X, AlertCircle, CheckCircle, XCircle, Clock, Video } from 'lucide-react';
            ...
            <CardBody className="p-4 space-y-4">
              ...
              {selectedEvent.status === 'Accepted' && (
                <Button
                  ...
                  onClick={() => {
                    const roomId = selectedEvent.allData.meetingLink || selectedEvent.allData._id;
              ...
              {selectedEvent.status === 'Pending' &&
               (selectedEvent.allData.receiver?._id === (currentUser as any)?.id || 
                selectedEvent.allData.receiver?._id === (currentUser as any)?._id ||
                selectedEvent.allData.receiver === (currentUser as any)?.id) && (
